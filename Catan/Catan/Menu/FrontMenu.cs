...
{
    public class FrontMenu : UserInterfaceElement
    {
        ...
        private static readonly Color ItemHighlightColor = Color.Red;
        ...
        public FrontMenu(Game game, string title, EventHandler showMenuHandler = null, EventHandler hideMenuHandler = null)
        ...
        public override void Draw(SpriteBatch spriteBatch)
        {
            ...
            // Draw title
            Vector2 itemPosition = new Vector2(this.Rectangle.X + FrontMenu.TitleOffsetX, this.Rectangle.Y + FrontMenu.TitleHeight);
            spriteBatch.DrawString(this.menuFont, this.Title, itemPosition, FrontMenu.ItemColor);
            itemPosition.Y += FrontMenu.TitleHeight;

            // Draw items
            itemPosition.X = this.Rectangle.X + FrontMenu.ItemsOffsetX;
            for (int index = 0; index < this.Items.Count; index++)
            {
                Color color = FrontMenu.ItemColor;
                if (highlightPosition == index)
                {
                    color = FrontMenu.ItemHighlightColor;
                }
                itemPosition.Y += FrontMenu.ItemsHeight;
